...
CREATE TABLE IF NOT EXISTS `panier` (
  `id` int NOT NULL AUTO_INCREMENT,
  `veloType` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT '',
  `veloImg` varchar(50) NOT NULL DEFAULT '0',
  `prixTotal` float NOT NULL DEFAULT '0',
  `heuresTotal` float NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- Listage des données de la table locabikedb.panier : ~0 rows (environ)
INSERT INTO `panier` (`id`, `veloType`, `veloImg`, `prixTotal`, `heuresTotal`) VALUES
	(1, 'Vélo Adult', 'image/ville.jpg', 18, 24);
