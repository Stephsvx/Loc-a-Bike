...
-- Dumping data for table locabikedb.location: ~0 rows (approximately)
INSERT INTO `location` (`id`, `locationType`, `prix1h`, `prix2h`, `prix5h`, `prix24h`, `locationDescription`) VALUES
	(0, 'Vélo Adulte', 6, 9, 12, 18, 'Panier, antivol et porte bébé inclus'),
	...
	(3, 'Vélo Électrique', 15, 20, 25, 35, '\r\n\r\nPanier et antivol inclus\r\n');
